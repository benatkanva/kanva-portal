...
// Make OrderDetailsManager available globally
if (typeof window !== 'undefined') {
    window.OrderDetailsManager = OrderDetailsManager;
}
...
// Auto-initialization when loaded in browser
if (typeof document !== 'undefined') {
    ...
    function initOrderDetails() {
        if (window.calculator) {
            ...
            if (typeof orderDetails.initialize === 'function') {
                orderDetails.initialize();
            }
        } else if (window.KanvaApp && window.KanvaApp.calculator) {
            orderDetails = new OrderDetailsManager(window.KanvaApp.calculator);
            if (typeof orderDetails.initialize === 'function') {
                orderDetails.initialize();
            }
        } else {
